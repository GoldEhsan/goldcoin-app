...
-- 2. Create the game_profiles table
...
CREATE TABLE public.tasks (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  profile_id BIGINT NOT NULL REFERENCES public.game_profiles(id) ON DELETE CASCADE,
  title TEXT NOT NULL,
  reward INT NOT NULL,
...
COMMENT ON TABLE public.game_profiles IS 'Stores game-specific data for each user.';
